		...
		<%@taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
			<%@taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
				...
				<body>
					...
					<br>
					<div class="container">
						<div class="row" style="background-color: #E8C2C2; margin-bottom: 20px">
								...
								<div class="welcomelogin">
									...
									<div>
										<a href="${pageContext.request.contextPath}/user/formDangNhap"><button
												class="btn btn-danger fs14"
												style="color: black;border:1px solid black">Đăng nhập</button></a>
									</div>
								</div>
							</div>
							<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
								<div class="login">
									...
									<form:form action="${pageContext.request.contextPath}/user/dangky" method="post"
										...
										<div class="form-group">
											...
											<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
												<form:input placeholder="Nhập họ tên" cssClass="form-control fs14"
													path="tenNguoiDung" />
												<span style="color: red">
													<form:errors path="tenNguoiDung"></form:errors>
												</span>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label class="col-xs-4 col-sm-4 col-md-4 col-lg-4"><b>Số điện thoại</b></label>
											<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
										...
										<div class="form-group">
											<label class="col-xs-4 col-sm-4 col-md-4 col-lg-4"><b>Địa chỉ</b></label>
											<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
												<form:input placeholder="Nhập số địa chỉ" cssClass="form-control fs14"
													path="diaChi" />
												<span style="color: red">
										...
										<div class="form-group">
											<label class="col-xs-4 col-sm-4 col-md-4 col-lg-4"><b>Mật khẩu</b></label>
											<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
												<form:password placeholder="Nhập mật khẩu" cssClass="form-control fs14"
													path="matKhau" />
												<span style="color: red">
